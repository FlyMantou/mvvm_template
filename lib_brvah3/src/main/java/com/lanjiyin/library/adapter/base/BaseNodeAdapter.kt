package com.lanjiyin.library.adapter.base
...
import com.lanjiyin.library.adapter.base.entity.node.NodeFooterImp
import com.lanjiyin.library.adapter.base.provider.BaseItemProvider
...
//            notifyItemRangeChanged(parentIndex + 1 + getHeaderLayoutCount(), max(removeCount, newFlatData.size))
     ...
     */
    private fun collapse(@androidx.annotation.IntRange(from = 0) position: Int,
     ...
     * @param notify Boolean
     */
    private fun expand(@androidx.annotation.IntRange(from = 0) position: Int,
     ...
     */
    @JvmOverloads
    fun collapse(@androidx.annotation.IntRange(from = 0) position: Int,
                 animate: Boolean = true,
                 notify: Boolean = true,
                 parentPayload: Any? = null): Int {
     ...
     */
    @JvmOverloads
    fun expand(@androidx.annotation.IntRange(from = 0) position: Int,
               animate: Boolean = true,
               notify: Boolean = true,
               parentPayload: Any? = null): Int {
     ...
     */
    @JvmOverloads
    fun expandOrCollapse(@androidx.annotation.IntRange(from = 0) position: Int,
                         animate: Boolean = true,
                         notify: Boolean = true,
                         parentPayload: Any? = null): Int {
        val node = this.data[position]
    ...
    @JvmOverloads
    fun expandAndChild(@androidx.annotation.IntRange(from = 0) position: Int,
                       animate: Boolean = true,
                       notify: Boolean = true,
                       parentPayload: Any? = null): Int {
    ...
    @JvmOverloads
    fun collapseAndChild(@androidx.annotation.IntRange(from = 0) position: Int,
                         animate: Boolean = true,
                         notify: Boolean = true,
                         parentPayload: Any? = null): Int {
     ...
     */
    @JvmOverloads
    fun expandAndCollapseOther(@androidx.annotation.IntRange(from = 0) position: Int,
    ...
    fun findParentNode(@androidx.annotation.IntRange(from = 0) position: Int): Int {
        if (position == 0) {
            return -1
        }
        val node = this.data[position]
