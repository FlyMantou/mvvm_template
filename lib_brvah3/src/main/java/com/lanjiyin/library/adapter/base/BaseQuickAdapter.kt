...
import com.lanjiyin.library.adapter.base.animation.*
import com.lanjiyin.library.adapter.base.diff.BrvahAsyncDiffer
import com.lanjiyin.library.adapter.base.diff.BrvahAsyncDifferConfig
import com.lanjiyin.library.adapter.base.diff.BrvahListUpdateCallback
import com.lanjiyin.library.adapter.base.listener.*
import com.lanjiyin.library.adapter.base.module.*
...
@JvmOverloads constructor(@LayoutRes private val layoutResId: Int,
     ...
     */
    open fun getItem(@androidx.annotation.IntRange(from = 0) position: Int): T {
        return data[position]
    }

    open fun getItemOrNull(@androidx.annotation.IntRange(from = 0) position: Int): T? {
